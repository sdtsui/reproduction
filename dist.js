...
// CONCATENATED MODULE: ./scroll-tools.js


const whenOnScreen = ({ element, offset = 300, lookup = () => {} }) => {
	return new Promise((resolve) => {
		const tester = () => {
			const conditionMet = isInViewport(element, { offset });
			if (conditionMet) {
				resolve();
			}
			return !conditionMet;
		...
		lookup(tester);
		listenToScroll(tester);
	});
};

// CONCATENATED MODULE: ./viewport-utils.js
